...
## 三、AES 加载
获取储存 AES Key 的文件链接
本项目AESkey文件链接为：https://raw.githubusercontent.com/sannnnnnns/AES_Keys/refs/heads/main/AES_Keys.json

菜单栏点击 Settings → 找到 AES 并点击
在 AES 配置界面：
左侧输入框中填入储存 AES Key 的文件链接（上文提供的那个），点击 Send
...
**本教程仅提供技术学习参考，请遵守相关游戏的使用条款。如果使用了这个仓库即默认了遇到法律问题需自行承担，作者及原作者不承担任何后果**
